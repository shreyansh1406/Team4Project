...
public class Checkout {
	...
	public Checkout(String fullname, String email, String address, String city, String state, int zip, int expyear,
			int cvv, String expmonth, int cno, String namecard) {
		super();
	...
	public String toString() {
		return "Checkout [fullname=" + fullname + ", email=" + email + ", address=" + address + ", city=" + city
				+ ", state=" + state + ", zip=" + zip + ", expyear=" + expyear + ", cvv=" + cvv + ", expmonth="
				+ expmonth + ", cno=" + cno + ", namecard=" + namecard + "]";
	}
